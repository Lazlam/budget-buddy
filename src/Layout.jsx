...
import { supabase } from "@/api/supabase"; // 1. Imported Supabase
...
export default function Layout({ children, currentPageName }) {
  ...
  // 2. Created the real logout function
    ...
    <div className="flex min-h-screen bg-gray-50/50">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-gray-100 p-6">
        <div className="mb-10">
          ...
          <p className="text-xs text-gray-400 mt-0.5">Smart money management</p>
        </div>
        ...
        {/* 3. Updated Desktop Logout Button */}
        <Button variant="ghost" className="justify-start text-gray-400 hover:text-red-500 mt-4" onClick={handleLogout}>
